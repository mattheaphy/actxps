...
- Policy 2 was issued on May 27, 2011 and was terminated in 2020 due to death. The death occurred after the 9th policy anniversary, therefore we expect 10 fully exposed years and a partial exposure in the 10th year.
- Policy 3 was issued on November 19, 2009 and was terminated in 2022 due to surrender The surrender occurred after the 11th policy anniversary, therefore we expect 11 fully exposed years and a partial exposure in the 12th year.
...
Verify that the exposure on the surrendered policy increased to 100% in the last exposure period.
...
Looking at the second policy, we can see that the first year is left-censored because the policy was issued 2/5 of the way through the year, and the last period is right-censored because the policy terminated roughly 7/10 of the way through the year.
