...
```{r, warning=FALSE, message=FALSE, fig.height=3, fig.width=4.5, dpi = 400}
...
```{r, echo=FALSE}
# necessary to avoid printing of excessive HTML / CSS
autotable(exp_res, groupname_col = "inc_guar") |> gt::as_raw_html()
```
